...
namespace Persons.DAL.Repositories
{
    public class PersonRepository : IPersonRepository
    {
        ...
        public bool DeleteItem(int id)
        {
            ...
            try
            {
                data.RemoveAt(data.IndexOf(person));
                return true;
            }
            catch (Exception)
            {
        ...
        {
            return data.Where(p => p.FirstName == searchQuery).ToList();
        }
        ...
        public List<Person> data = new()
        {
            ...
            new Person { Id = 16, FirstName = "Vincent", LastName = "Fox", Email = "faucibus.Morbi.vehicula@ipsumdolor.edu", Company = "Imperdiet Dictum Foundation", Age = 54 },
            ...
            new Person { Id = 49, FirstName = "Jenette", LastName = "Dejesus", Email = "adipiscing.Mauris.molestie@liberoduinec.ca", Company = "Lectus Incorporated", Age = 56 },
